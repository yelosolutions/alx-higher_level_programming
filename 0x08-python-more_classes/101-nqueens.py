#!/usr/bin/python3
"""
Module with an algorithm that resolves the N-Queen puzzle
using backtracking
"""


def isChess(m_queen, nqueen):
    """ Method that determines if queens can or can't kill each other
    Args:
        m_queen: array with queens positions
        nqueen: queen number
    Returns:
